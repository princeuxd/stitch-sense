...
const features = [
  {
    ...
    title: "Smart Upload",
    description:
      "Take photos of your clothes and let AI identify everything automatically",
  },
  {
    icon: Brain,
    title: "AI Styling",
    description:
      "Get personalized outfit recommendations based on weather, occasion, and style",
  },
  {
    icon: Palette,
    title: "Color Coordination",
    description:
      "Never wonder what goes together - smart color matching for perfect outfits",
  },
];
          ...
          <div className="space-y-8 animate-fade-up">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg">
                Upload photos of your clothes, get AI-powered outfit
                suggestions, and never wonder "what to wear" again. Your
